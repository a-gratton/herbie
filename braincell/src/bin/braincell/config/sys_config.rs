...
pub const NUM_LEGS_IN_RACE: usize = 2;
...
pub const FRONT_DISTANCE_TARGETS_MM: [i32; NUM_LEGS_IN_RACE] = [120, 120];
pub const LEFT_DISTANCE_TARGETS_MM: [i32; NUM_LEGS_IN_RACE] = [95, 95];
